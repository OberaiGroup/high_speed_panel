...
strain_rate=@(e_c,t) (exp(-Q_R/(temperature(t, T_0, T_f, t_ss, t_flight))) *( stress_ratio*abs( alpha*(temperature(t, T_0, T_f, t_ss, t_flight) - T_0) + e_c))^n*sign(-(alpha*(temperature( t, T_0, T_f, t_ss, t_flight)-T_0) + e_c)));
...
% lsode_options( "step limit", 1.0E+6);
...
dlmwrite( "data/alb_solution.txt",    solution,        "delimiter", " ");
dlmwrite( "data/alb_temperature.txt", temp_time,       "delimiter", " ");
dlmwrite( "data/alb_sigma.txt",       sig_time,        "delimiter", " ");
dlmwrite( "data/alb_sig_ratio.txt",   sig_ratio_time,  "delimiter", " ");
...
if n_flight == 2
  ...
  dlmwrite( "data/alb_takeoff_solution.txt",   takeoff_solution,   "delimiter", " ");
  dlmwrite( "data/alb_touchdown_solution.txt", touchdown_solution, "delimiter", " ");
end
