#!/bin/bash
#SBATCH -J flat_25s_2d_16c_interp
#SBATCH --nodes=1
#SBATCH --ntasks=16
...
export dir=/project/aoberai_286/jlclough/high_speed_panel/plate_no_stiffeners/plasticity_and_creep/hpc_analytical_temperature
cd $dir
